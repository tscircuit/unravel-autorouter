...
export class UnravelSectionSolver extends BaseSolver {
  ...
  currentCandidate: UnravelCandidate | null = null
  ...
  visualize(): GraphicsObject {
    ...
    if (this.currentCandidate) {
      for (const issue of this.currentCandidate.issues) {
      ...
      for (const [segmentPointId, modification] of this.currentCandidate
        .pointModifications) {
        const originalPoint =
          this.unravelSection.segmentPointMap.get(segmentPointId)!
